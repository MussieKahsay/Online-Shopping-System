...
const AllProductAdmin = () => {
  ...
  const deleteReview = (reviewId, productId) => {
    api
      .delete(`/ecom/product-reviews/${reviewId}`)
      .then(() => {
        setReviews((prevReviews) => ({
          ...prevReviews,
          [productId]: prevReviews[productId].filter(
          ...
          <div className="product-card1" key={product.productId}>
            ...
            <div className="product-info1">
              ...
              <div className="button-container1">
                ...
                <button onClick={() => fetchReviews(product.productId)}>
                  Show Reviews
                </button>
              </div>
              {showReviews[product.productId] && (
                <div className="reviews-container">
                  {reviews[product.productId]?.map((review) => (
                    <div key={review.reviewId} className="review-item">
                      ...
                      <button
                        onClick={() =>
                          deleteReview(review.reviewId, product.productId)
                        }
                      >
                        Delete Review
                      </button>
